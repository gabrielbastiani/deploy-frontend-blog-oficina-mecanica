...
import { UpdateCategoryUserProps } from '../../pages/newCategory/index';
...
interface ModalUpdateUserUserCategory {
    isOpen: boolean;
    onRequestClose: () => void;
    onRefreshList: () => void;
    category: UpdateCategoryUserProps[];
}

export function ModalUpdateUserCategory({ isOpen, onRequestClose, onRefreshList, category }: ModalUpdateUserUserCategory) {
